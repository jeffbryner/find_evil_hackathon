...
class SIFTOrchestrator:
    def __init__(self, image_name="digitalsleuth/sift-docker:jammy"):
        # Use Colima socket
        self.client = docker.DockerClient(base_url="unix:///Users/jeffbryner/.colima/default/docker.sock")
    ...
    def mount_evidence(self, evidence_file):
        ...
        if match:
            ...
            mount_cmd = f"mount -t ntfs -o ro,loop,offset={offset} /mnt/ewf/ewf1 /mnt/windows"
